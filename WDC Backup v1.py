...
# 結束後自動關閉選項
var_auto_close = ttk.BooleanVar(value=True)
ttk.Checkbutton(root, text="結束後自動關閉", variable=var_auto_close).grid(row=12, column=0, padx=10, pady=10, columnspan=3, sticky="w")
